...
namespace BeaconColorPicker.BZ
{
    public static class CustomColorStore
    {
        ...
        private static string FilePath => Path.Combine(
            BepInEx.Paths.ConfigPath, "com.zerotheabsolute.beaconcolorpicker.bz.json");
        ...
        public static void Save()
        {
            ...
            {
                BeaconColorPickerBZPlugin.Log?.LogWarning($"Failed to save custom colors: {ex.Message}");
            }
        }
        ...
        public static void Load()
        {
            ...
            {
                BeaconColorPickerBZPlugin.Log?.LogWarning($"Failed to load custom colors: {ex.Message}");
