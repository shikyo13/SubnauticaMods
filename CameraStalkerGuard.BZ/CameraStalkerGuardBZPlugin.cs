...
namespace CameraStalkerGuard.BZ
{
    [BepInPlugin(PLUGIN_GUID, PLUGIN_NAME, PLUGIN_VERSION)]
    public class CameraStalkerGuardBZPlugin : BaseUnityPlugin
    {
        public const string PLUGIN_GUID = "com.zerotheabsolute.camerastalkerguard.bz";
        public const string PLUGIN_NAME = "CameraStalkerGuard BZ";
