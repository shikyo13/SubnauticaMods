...
namespace BetterSeaglide.Patches
{
    ...
    internal static class SeaglideBoostActivatePatch
    {
        ...
        static void Postfix(Seaglide __instance)
        {
            try
            {
                if (!BetterSeaglidePlugin.Config.ToggleBoost) return;
    ...
    internal static class UnderwaterMotor_AlterMaxSpeed_Patch
    {
        ...
        static void Postfix(ref float __result)
        {
            try
            {
                ...
                if (boosting)
                {
                    __result += BetterSeaglidePlugin.Config.BoostAddition;
                    __result *= BetterSeaglidePlugin.Config.BoostMultiplier;
                }
