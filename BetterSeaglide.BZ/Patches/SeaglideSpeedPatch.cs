    ...
    internal static class UnderwaterMotor_AlterMaxSpeed_Patch
    {
            ...
            ref float ___currentPlayerSpeedMultipler)
        {
            try
            {
                ...
                if (BetterSeaglideBZPlugin.Config.ToggleBoost)
                {
                    ...
                    {
                        speed += BetterSeaglideBZPlugin.Config.BoostAddition;
                        speed *= BetterSeaglideBZPlugin.Config.BoostMultiplier;
                    }
                }
                ...
                ___currentPlayerSpeedMultipler = Mathf.MoveTowards(___currentPlayerSpeedMultipler, __instance.playerSpeedModifier.Value, 0.3f * Time.deltaTime);
